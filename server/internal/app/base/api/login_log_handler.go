...
import (
	...
	_ "github.com/ix-pay/ixpay-pro/internal/dto/base/response" // Swagger 注解使用
...
//	@Success		200			{object}	baseRes.Response{data=response.LoginLogListResponse,msg=string}	"登录日志列表"
...
//	@Success		200			{object}	baseRes.Response{data=response.LoginLogDetailResponse,msg=string}	"登录日志详情"
//	@Failure		400	{object}	map[string]string						"请求参数错误"
//	@Failure		401	{object}	map[string]string						"未授权"
//	@Failure		500	{object}	map[string]string						"服务器内部错误"
