...
func InitializeApp() (*Application, error) {
	...
	onlineUserService := service.NewOnlineUserService(onlineUserRepository, cacheCache, loggerLogger)
	userService := service.NewUserService(userRepository, userSettingRepository, roleService, rolePermissionService, jwtAuth, configConfig, loggerLogger, cacheCache, captchaCaptcha, loginLogService, onlineUserService)
	...
	taskRepository := persistence.NewTaskRepository(postgresDB)
	taskService := service.NewTaskService(taskRepository, loggerLogger)
	...
	nodeRegistry := task.SetupNodeRegistry(client)
