...
type PermissionGroup struct {
	...
	Sort        int       // 排序
	APIRouteIds []string  // 权限组关联的接口路由 ID 列表
	BtnPermIds  []string  // 权限组关联的按钮权限 ID 列表
	RoleIds     []string  // 权限组关联的角色 ID 列表
...
func (p *PermissionGroup) HasAPI(apiID string) bool {
...
func (p *PermissionGroup) HasBtnPerm(btnPermID string) bool {
...
func (p *PermissionGroup) HasRole(roleID string) bool {
