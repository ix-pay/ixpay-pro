...
func (ms *MenuSeed) Init(db *database.PostgresDB, logger logger.Logger) error {
	...
	_, err := ms.createOrGetMenu(logger, &entity.Menu{
		Path:        "index",
		Name:        "Index",
		Component:   "view/base/index/index",
		Title:       "首页",
		Icon:        "Dashboard",
		Hidden:      false,
		Sort:        0,
	...
	deptMenu, err := ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/system/department/index",
		Title:       "部门管理",
		Icon:        "Folder",
		Hidden:      false,
		Sort:        4,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/system/position/index",
		Title:       "职位管理",
		Icon:        "User",
		Hidden:      false,
		Sort:        5,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Path:        "dict",
		Name:        "DictManagement",
		Component:   "view/system/dict/index",
		Title:       "字典管理",
		Icon:        "Document",
		Hidden:      false,
		Sort:        6,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/system/config/index",
		Title:       "系统配置",
		Icon:        "Setting",
		Hidden:      false,
		Sort:        7,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/system/notice/index",
		Title:       "公告管理",
		Icon:        "Bell",
		Hidden:      false,
		Sort:        8,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/system/api-route/index",
		Title:       "API 管理",
		Icon:        "Connection",
		Hidden:      false,
		Sort:        9,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Path:        "task",
		Name:        "ScheduledTask",
		Component:   "view/task/task/index",
		Title:       "定时任务管理",
		Icon:        "Clock",
		Hidden:      false,
		Sort:        1,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Path:        "monitor",
		Name:        "Monitor",
		Component:   "view/monitor/monitor/index",
		Title:       "系统监控",
		Icon:        "Monitor",
		Hidden:      false,
		Sort:        1,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/monitor/online-user/index",
		Title:       "在线用户",
		Icon:        "UserFilled",
		Hidden:      false,
		Sort:        2,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/log/operation-log/index",
		Title:       "操作日志",
		Icon:        "Tickets",
		Hidden:      false,
		Sort:        1,
	...
	_, err = ms.createOrGetMenu(logger, &entity.Menu{
		...
		Component:   "view/log/login-log/index",
		Title:       "登录日志",
		Icon:        "DocumentCopy",
		Hidden:      false,
		Sort:        2,
