...
type UpdateDictRequest struct {
	ID int64 `json:"id,string" binding:"required,gt=0"` // 字典 ID
	DictRequest
}
...
type DictItemRequest struct {
	DictID      int64  `json:"dictId,string" binding:"required,gt=0"` // 字典 ID
...
type UpdateDictItemRequest struct {
	ID int64 `json:"id,string" binding:"required,gt=0"` // 字典项 ID
	DictItemRequest
}
