...
// @accept application/json
// @Produce application/json
// @Param data body {id:"string",nickname:"string",email:"string",phone:"string",avatar:"string",departmentId:"number",positionId:"number",status:"number",roles:"array"} true "更新用户请求参数"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"修改成功"}"
...
// @Router /user/setUserAuthority [post]
// @Deprecated
export const setUserAuthorityDeprecated = (
