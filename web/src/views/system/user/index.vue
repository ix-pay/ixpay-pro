...
import { getDepartmentList, type Department as DepartmentType } from '@/api/modules/department'
import { getPositionList, type Position as PositionType } from '@/api/modules/position'
...
// 岗位列表
const positionList = ref<PositionType[]>([])
// 对话框
